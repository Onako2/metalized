...
public class ModItems {
    public static void Init() {
        ...
        Registry.register(Registries.ITEM, Identifier.of("metalized", "netherite_stairs"), new BlockItem(Metalized.NETHERITE_STAIRS, new Item.Settings()));
        ...
        Registry.register(Registries.ITEM, Identifier.of("metalized", "netherite_ladder"), new BlockItem(Metalized.NETHERITE_LADDER, new Item.Settings()));
