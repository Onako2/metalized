...
public class ModItems {
    public static void Init() {
        ...
        Registry.register(Registries.ITEM, Identifier.tryParse("metalized", "netherite_stairs"), new BlockItem(Metalized.NETHERITE_STAIRS, new Item.Settings().fireproof()));
        ...
        Registry.register(Registries.ITEM, Identifier.tryParse("metalized", "netherite_ladder"), new BlockItem(Metalized.NETHERITE_LADDER, new Item.Settings().fireproof()));
